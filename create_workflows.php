...
if(isset($_POST['edit9'])){
	foreach($table8_heading as $value)
	{
		...
		// header('Location: '.BASE_URL().'/create_workflows.php?id='.$_GET['id']);
	}
}
...
<div class="table-responsive">
	...
	<form class = "frm_insert" method="post" action="create_workflows.php?id=<?php echo $odesso_app_id; ?>">
	...
	<!--- TABLE2 : EDIT Starts--->
	<form method="post" action="create_workflows.php?id=<?php echo $odesso_app_id; ?>">
