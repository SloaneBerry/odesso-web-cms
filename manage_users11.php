...
if (ss == 'APP_PROD_CLS'){
	alert('sss');
	$('.PROD_CLS').css({'background-color':'blue !important','color':'blue'});
}else if (ss == 'APP_DEV_CLS'){
	
	$('.DEV_CLS').css({'background-color':'blue !important','color':'blue'});
}else if (ss == 'APP_PT_CLS'){
	// alert('sss');
$('.PT_CLS').css({'background-color': 'blue !important','color':'blue'});
}  */ 
